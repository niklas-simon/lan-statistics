...
pub mod set_games_reducer;
pub mod set_userinfo_reducer;
...
pub use set_games_reducer::{set_flags_for_set_games, set_games, SetGamesCallbackId};
pub use set_userinfo_reducer::{set_flags_for_set_userinfo, set_userinfo, SetUserinfoCallbackId};
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            ...
            Reducer::SetGames { .. } => "set_games",
            Reducer::SetUserinfo { .. } => "set_userinfo",
        }
    }
}
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            ...
            .into()),
            "set_games" => Ok(
                __sdk::parse_reducer_args::<set_games_reducer::SetGamesArgs>(
                    "set_games",
                    &value.args,
                )?
                .into(),
            ...
            "set_userinfo" => Ok(
                __sdk::parse_reducer_args::<set_userinfo_reducer::SetUserinfoArgs>(
                    "set_userinfo",
                    &value.args,
                )?
                .into(),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.game = cache.apply_diff_to_table::<Game>("game", &self.game);
        diff.user = cache
